 ...
 * @return {Stream}
 */
gulp.task('fonts', ['our-fonts'], function () {
  log('Copying fonts');
 ...
 * @return {Stream}
 */
gulp.task('our-fonts', ['clean-fonts'], function () {
...
gulp.task('favicon', function () {
  log('Output favicon.ico');

  return gulp
    .src(config.server + 'favicon.ico')
 ...
 * @return {Stream}
 */
gulp.task('optimize', ['inject', 'test', 'favicon'], function () {
...
gulp.task('test', ['templatecache'], function (done) {
  ...
  /*5/25/2015 - ed- I removed vet as a task here, add it later */
});
